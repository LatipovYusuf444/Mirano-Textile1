...
import img1 from "@/assets/images/close-up-image-lot-coils-with-threads-sewing-workshop.webp"
import img2 from "@/assets/images/elegant-old-woman-sitting-studio-sew-cloth.webp"
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          ">
            ...
            malakali mutaxassislar bilan uyg‘unlashtirib,
            qisqa vaqt ichida yetakchi kompaniyaga aylandi.
          </p>
